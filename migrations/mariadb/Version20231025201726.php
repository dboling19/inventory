 ...
 */
final class Version20231025201726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (item_code VARCHAR(8) NOT NULL, unit_code VARCHAR(10) NOT NULL, item_name VARCHAR(50) NOT NULL, item_desc LONGTEXT DEFAULT NULL, item_exp_date DATETIME DEFAULT NULL, INDEX IDX_1F1B251EFBD3D1C2 (unit_code), PRIMARY KEY(item_code)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item_location (item_code VARCHAR(8) NOT NULL, loc_code VARCHAR(8) NOT NULL, whs_code VARCHAR(8) NOT NULL, quantity INT NOT NULL, INDEX IDX_32934100BF257463 (item_code), INDEX IDX_32934100FDEA9CFB (loc_code), INDEX IDX_329341001A4A8D93 (whs_code), PRIMARY KEY(item_code, loc_code, whs_code)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE location (loc_code VARCHAR(8) NOT NULL, loc_name VARCHAR(255) NOT NULL, PRIMARY KEY(loc_code)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE purchase_order (po_num INT AUTO_INCREMENT NOT NULL, vendor_code VARCHAR(10) DEFAULT NULL, terms_code VARCHAR(3) NOT NULL, po_ship_code VARCHAR(6) NOT NULL, po_status VARCHAR(1) NOT NULL, po_freight NUMERIC(9, 2) NOT NULL, po_received SMALLINT NOT NULL, po_paid SMALLINT NOT NULL, po_order_date DATETIME NOT NULL, po_price NUMERIC(10, 2) NOT NULL, INDEX IDX_21E210B25DD83547 (vendor_code), INDEX IDX_21E210B26F6CFA46 (terms_code), PRIMARY KEY(po_num)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE purchase_order_line (po_num INT NOT NULL, item_code VARCHAR(8) DEFAULT NULL, po_line SMALLINT NOT NULL, po_status VARCHAR(1) NOT NULL, qty_ordered NUMERIC(9, 2) DEFAULT NULL, qty_received NUMERIC(9, 2) DEFAULT NULL, qty_rejected NUMERIC(9, 2) DEFAULT NULL, qty_vouchered NUMERIC(9, 2) DEFAULT NULL, item_cost NUMERIC(9, 2) DEFAULT NULL, po_due_date DATETIME NOT NULL, po_received_date DATETIME DEFAULT NULL, item_unit VARCHAR(3) DEFAULT NULL, po_received SMALLINT NOT NULL, po_paid SMALLINT NOT NULL, item_quantity INT NOT NULL, INDEX IDX_90D6D92BBF257463 (item_code), PRIMARY KEY(po_num)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vendor (vendor_code VARCHAR(10) NOT NULL, vendor_name VARCHAR(50) NOT NULL, vendor_desc LONGTEXT DEFAULT NULL, vendor_addr VARCHAR(50) DEFAULT NULL, vendor_email VARCHAR(20) DEFAULT NULL, vendor_phone VARCHAR(20) DEFAULT NULL, PRIMARY KEY(vendor_code)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE warehouse (whs_code VARCHAR(8) NOT NULL, whs_name VARCHAR(255) NOT NULL, whs_addr VARCHAR(255) DEFAULT NULL, PRIMARY KEY(whs_code)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
